...
function deactivated_theme()
{
    ...
    global $wpdb;
    $tables_lst = array("tblbooks", "tblborrowed", "tblcourses", "tblrequests", "tblstudents", "tblsubbooks", "tblyears", "tblusers", "tblslides");
...
function create_table_for_LMS()
{
    ...
    ('inst_name', 'UNIMAS', 'yes'),
    ('inst_cont_name', 'Loknath Das', 'yes'),
    ('inst_email', '007loknathdas@gmail.com', 'yes'),
    ('inst_website', 'http://fcsitlibrary.tk/', 'yes'),
    ('inst_phone', '082-583 780', 'yes'),
    ('inst_fax', '082-583 780', 'yes'),
    ('inst_address', ' Universiti Malaysia Sarawak, Sarawak', 'yes'),
    ('inst_zip', '94300', 'yes'),
    ('inst_city', 'Kota Samarahan', 'yes'),
    ('inst_gmap', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.5085239001496!2d110.42683191426511!3d1.4681649615940453!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31fba3ce88e3a4690xf0983c853635b29!2sFaculty+of+Computer+Science++Information+Technology+(FCSIT)!5e0!3m2!1sen!2smy!4v1555151690852!5m2!1sen!2smy', 'yes'),
    ('inst_state', 'Maharashtra', 'yes'),
    ('inst_frnt_desc', 'This is the FCSIT library where students can get their study resources from here. Students can borrow, download read the pdf version from there. This project for FYP demonstration purpose. If you any enquires please do not hesitate to contact with our contact details. - Have a nice day', 'yes'),
    ('inst_meta_desc', 'FCSIT library', 'yes'),
    ('inst_meta_title', 'FCSIT library', 'yes');";
    ...
    (4, '4th Year'),
    (5, '5th Year');";
    add_option("custom_states", "Johor,Kedah,Kelantan,Malacca,Negeri Sembilan,Pahang,Perak,Perlis,Penang,Sabah,Sarawak,Selangor,Terengganu,Others");
    ...
    add_option("payment_currency_code", 'MYR');
    ...
    add_option("front_page_s1", 'FCSIT Library Resources');
    add_option("waiting_approval_msg", "You have not submitted the book.After the submission the admin will approved the payment.Make sure to submit before due dates.");
    ...
    add_option("logo_css", "width: 100px;float: none;margin-left: 400px;margin-top: 3px;");
    add_option("custom_sms_template", "Book Issued {Java Web Development Illuminated} to you needs to be return to the library.");
    add_option("inst_in_cards", 'Admin need to upload the rules');
...
{
    global $current_user;
    update_user_meta($current_user->ID, 'lib_fname', "Loknath");
    update_user_meta($current_user->ID, 'lib_lname', "Das");
