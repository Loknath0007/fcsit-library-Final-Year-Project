...
function FuncUpdateCode()
{
    ...
    if (!file_exists(get_template_directory() . '/bck/lock.dat')) {
        ...
        if ($read_m_files == "") {
            echo json_encode(array('success' => true, 'msg' => 'No files found to be updated!', "header" => "Success", 'color' => 'success'));
            wp_die();
        }
        ...
        if (!if_updated()) {
            ...
            echo json_encode(array('success' => true, 'msg' => 'Files are already upto date.', "header" => "Success", 'color' => 'success'));
            wp_die();
        }
        ...
        echo json_encode(array('success' => true, 'msg' => 'Files are locked on server.', "header" => "Success", 'color' => 'success'));
        wp_die();
    }
}
