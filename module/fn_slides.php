...
function manage_slides()
{
    ...
    if ($action == "addslide") {
        ...
        if ($file_id != null) {
            ...
            $wpdb->query($sql);
            echo json_encode(array("status" => true, 'data' => "", "msg" => "Slide saved", "header" => "OK", "color" => "info"));
            wp_die();
        } else {
            echo json_encode(array("status" => true, 'data' => "", "msg" => "Slide could not be saved", "header" => "OK", "color" => "info"));
            wp_die();
        }
    ...
    if ($action == "editslide") {
        ...
        if ($file_id != null) {
            ...
            $wpdb->query($sql);
            echo json_encode(array("status" => true, 'data' => "", "msg" => "Slide updated", "header" => "OK", "color" => "info"));
            wp_die();
        } else {
            echo json_encode(array("status" => true, 'data' => "", "msg" => "Slide could not be saved", "header" => "OK", "color" => "info"));
            wp_die();
    ...
    if ($action == "delslide") {
        ...
        $wpdb->query($sql);
        echo json_encode(array("status" => true, 'data' => "", "msg" => "Slide deleted successfully.", "header" => "OK", "color" => "success"));
        exit();
    }
}
